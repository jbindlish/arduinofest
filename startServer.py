...
with gr.Blocks(title="ArduinoFest 2025 Sign offs",analytics_enabled=False) as container:
    ...
    with gr.Tab("Teacher Checkoff"):
        ...
        with gr.Accordion("Credentials"):
            ...
            authent = gr.Textbox(label="Enter teacher key here: ", type = "password")
...
if __name__ == "__main__":
    ...
    container.launch(server_port=80)
